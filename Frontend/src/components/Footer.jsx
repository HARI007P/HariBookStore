...
function Footer() {
  return (
    <footer className="bg-gradient-to-r  text-white">
      ...
      <div className="container mx-auto px-6 py-12 grid gap-10 md:grid-cols-3">
        ...
        <div className="space-y-4">
          ...
          <p>
            🏬{" "}
            <a
              href="https://www.google.com/maps?q=4-47+prakashbabu+bookstore,+Srikakulam,+Andhra+Pradesh,+India+532401"
              target="_blank"
        ...
        <div className="text-center md:text-right space-y-4">
          <h3 className="text-xl font-semibold text-pink-400">Follow Us</h3>
      ...
      <div>
        <p className="text-center text-sm md:text-base text-gray-400">
          ...
          <span className="text-pink-400 font-semibold">Hari Book Store</span>.  
          All rights reserved.
        </p>
      </div>
    </footer>
